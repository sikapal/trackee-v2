...
@Component
public class PrintingDeliveries extends JPanel implements Printable, ActionListener {

	    //JButton ok = new JButton("OK");
	    Image image = null;
	    Image image1 = null;

	    public PrintingDeliveries() {
	    ...
	    public void launch(File file, Delivery L) throws IOException {
	        new PrintingDeliveries();
	        //
	        JLabel label = new JLabel();
	        JLabel label1 = new JLabel();
	        JLabel label2 = new JLabel();
	        ...
	        label.setFont(new Font("Arial", Font.PLAIN, 29));
	        label.setText("ID livraison : "+L.getLabelLivraison());
	        //
	        label1.setFont(new Font("Arial", Font.PLAIN, 29));
	        //label1.setText("Matricule bus : "+L.getBus().getMatricule());
	        //
	        label2.setFont(new Font("Arial", Font.PLAIN, 29));
	        label2.setText("Ville depart : "+L.getVilleDepart());
	        //
	        label3.setFont(new Font("Arial", Font.PLAIN, 29));
	        label3.setText("Ville arrivée : "+L.getVilleArrivee());
	        //
